...
export default function CreditCardScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{color:colors.primary,position:"absolute",top:47,left:285}}>Naira</Text> 
      ...
      <TextInput
        ...
        style={{top:75,width:"20%",left:15,borderBottomColor: 'gray',borderBottomWidth: 1,}}
      ...
      <TextInput
        ...
        style={{top:25,width:"20%",left:205,borderBottomColor: 'gray',borderBottomWidth: 1,}}
        
      />

      <Text style={{color:"black",top:50,left:20,backgroundColor: "#EDE8E8",fontSize:11,width: 300,borderRadius: 10,padding:10}}>You agree to Authorise the use of your credit card for this deposit and future payments.</Text>
