  ...
  return (
    <Top.Navigator
      tabBarOptions={{
        ...
        style: { width: "90%", left: 20, borderRadius: 10, overflow: "hidden" },
    ...
    >
      <Top.Screen name="Credit Card">{() => <CreditCardScreen />}</Top.Screen>
      <Top.Screen name="Bank Deposit">{() => <BankDepositScreen />}</Top.Screen>
    </Top.Navigator>
  );
};
